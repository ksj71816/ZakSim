	...
	<div class="row">
		...
		<c:forEach var="groupInfo" items="${groupInfo }">
			...
			<div class="col-sm-11" style="margin-top: 50px; margin-right: 50px;">
				...
				${sessionScope.login_idx }
				<br>
				${groupInfo.communityGroup.member_idx }
				...
				<button type="button" class="btn btn-outline-info"
					...
					하기</button>
<%-- 				<c:if test="${groupMember.member_idx eq sessionScope.login_idx }"> --%>
				<button type="button" class="btn btn-outline-success" id = "btnRecommend"
					...
					<div style="margin-left: 150px; margin-right: 150px;">
						<div id="comment">
							<br> <img src="/resources/image/community/sample.png"
								...
								style="margin-left: 30px; font-size: 25px;">${boardList.zakSimMember.nick }</strong></span> <br>
							...
							<div class="row">
								...
								<div class="col"
									...
									<strong style="cursor: pointer;"> ♡ 좋아요 ${boardList.hit }개</strong>
								</div>
							</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form id="form1" action="/zaksim/community/updateCommunity"
				method="post" runat="server" enctype="multipart/form-data" onsubmit="return update();" >
				<c:forEach var="groupInfo" items="${groupInfo }">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel"
								...
								<div class="">
									<div class="form-inline">
										<div>
											...
											<input type="hidden" name="image" value="${groupInfo.communityGroup.image }" />
									...
									<div style="margin-top: 30px;">
												...
												<div class="screctRadio" style="vertical-align: top;">
													<div class="card-body">
														...
														<span style="margin-left: 140px; display: none;"
															id="passComment" onkeypress="isSame(${groupInfo.communityGroup.idx})"></span>
													</div>
												</div>
											</div>
										</c:if>
										...
										<c:set var="catego"  value="${groupInfo.communityCategory.idx}"   />
										...
										<div class="form-inline">
											...
											id="contentText"
												...
												>${groupInfo.communityGroup.content}</textarea>
